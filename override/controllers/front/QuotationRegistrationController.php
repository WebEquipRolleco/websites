    ...
    **/
    public function initContent() {
        ...
        if($form) {
            ...
            Mail::send(1, "quotation_request", "Demande de devis", $tpl_vars, Configuration::get('PS_SHOP_EMAIL'), "Web-equip", Configuration::get('PS_SHOP_EMAIL'), trim($form['firstname']." ".$form['lastname'])
