...
class ContactController extends ContactControllerCore {
	...
	public function postProcess() {
		...
		if($form = Tools::getValue('contact')) {
			...
			if(Mail::send(1, 'contact', "Contact client", $templateVars, Configuration::get('PS_SHOP_EMAIL'), Configuration::get('PS_SHOP_NAME'), $form['email'], trim($form['firstname'].' '.$form['lastname'])))
