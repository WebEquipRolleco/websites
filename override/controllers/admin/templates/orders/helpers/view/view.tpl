            ...
            {foreach from=OA::findByOrder($order->id) item='oa'}
              <form method="post">
                <tr>
                  ...
                  <td class="text-right">
                    <div class="btn-group">
                      <a class="btn btn-default" title="{l s='Bon de commande'}">
                        <span class="icon-file"></span>
                      </a>
                      <a class="btn btn-default" title="{l s='Bon de livraison'}">
              ...
              <tr>
                <td>
                  <select name="new_oa[id_supplier]" required>
                    <option value="">{l s="Fournisseur"}</option>
                    {foreach from=$suppliers item=supplier}
                ...
                <td>
                  <input type="text" name="new_oa[code]" autocomplete="off" required>
                </td>
                <td colspan="3"></td>
                <td class="text-right">
      ...
      <div class="panel">
        ...
        <form method="post">
          ...
          <div class="text-right">
            <button type="submit" class="btn btn-primary" name="save_supplier_information">{l s='Enregistrer'|upper d='Admin.Actions'}</button>
          </div>
        </form>
      </div>
    </div>
    <div class="col-lg-6">
      <div class="panel">
        ...
        <form method="post">
          ...
          <div class="text-right">
            <button type="submit" class="btn btn-primary" name="save_delivery_information">{l s='Enregistrer'|upper d='Admin.Actions'}</button>
          </div>
        </form>
      </div>
    </div>
              ...
              <tr>
                <td class="text-center" style="padding:5px">
                  <div class="label label-default">
                    <input type="checkbox" name="documents[]" value="BC" style="vertical-align:middle"> 
                    <b>{l s="Bon de commande"}</b>
                  </div>
                </td>
                <td class="text-center" style="padding:5px">
                  <div class="label label-default">
                    <input type="checkbox" name="documents[]" value="BL" style="vertical-align:middle"> 
