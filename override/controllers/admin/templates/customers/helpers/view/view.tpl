...
<div class="row">
	...
	{if $state}
	    <div class="row">
	    	<div class="col-lg-12">
	        	<div class="panel">
	          		<span class="label" style="background-color:{$state->color};{if $state->light_text}color:white;{/if}">
	          			<b>{$state->name}</b>
	          		</span> 
	          		{if $customer->comment}
	            		&nbsp;- {$customer->comment}
    	...
    	<div class="row">
      		<div class="col-lg-12">
        		<div class="panel">
          			...
          			{if $customer->date_funding != '0000-00-00'}
            			- {$customer->date_funding|date_format:'d/m/Y'}
          			{/if}
        		</div>
      		</div>
    	</div>
