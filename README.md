...
ALTER TABLE `ps_product` ADD `delivery_fees` FLOAT DEFAULT '0' AFTER `state`;
ALTER TABLE `ps_product` ADD `rollcash` FLOAT DEFAULT '0' AFTER `delivery_fees`;
...
CREATE TABLE IF NOT EXISTS `ps_quotation` (
    ...
    `hidden_emails` VARCHAR(255) DEFAULT NULL,
