<section>
	...
	<br />
  	...
  	<b>{$TO}</b>
  	<br />
  	<b>{l s="CIC : " mod="webequip_payment_administrative"} {$CIC}</b>
  	<br />
  	<b>{l s="IBAN : " mod="webequip_payment_administrative"} {$IBAN} - {l s="BIC : " mod="webequip_payment_administrative"} {$BIC}</b> <br />
  	<br />
  	<b><u class="text-danger">{l s="Merci d'indiquer votre numéro de commande en référence." mod="webequip_payment_administrative"}</u></b>
</section>