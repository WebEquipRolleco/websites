          ...
          <div class="col-md-6 divide-right">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                {/foreach}
                <p class="quantity"><strong>{l s='Quantity:' d='Shop.Theme.Checkout'}</strong>&nbsp;{$product.cart_quantity}</p>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="cart-content">
              ...
              {/if}
              <p class="total-price"><strong>{l s='Total:' d='Shop.Theme.Checkout'}</strong>&nbsp;{$cart.totals.total.value} {$cart.labels.tax_short}</p>
