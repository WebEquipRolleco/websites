    ...
    <div class="hidden-sm-down">
      <table id="order-products" class="table table-bordered return">
        <thead class="thead-default">
          <tr>
            <th class="bg-blue head-checkbox"><input type="checkbox"/></th>
            <th class="bg-blue">{l s='Product' d='Shop.Theme.Catalog'}</th>
            <th class="bg-blue">{l s='Quantity' d='Shop.Theme.Catalog'}</th>
            <th class="bg-blue">{l s='Returned' d='Shop.Theme.Customeraccount'}</th>
          ...
          {foreach $order.subtotals as $line}
            {if $line.value}
              <tr class="text-xs-right line-{$line.type}">
                <td colspan="5" class="bold">{$line.label}</td>
                <td colspan="2">{$line.value}</td>
              </tr>
            {/if}
          {/foreach}
          <tr class="text-xs-right line-{$order.totals.total.type}">
            <td colspan="5" class="bold">{$order.totals.total.label}</td>
