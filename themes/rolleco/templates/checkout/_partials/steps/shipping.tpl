      ...
      >
        <div class="form-fields">
          {block name='delivery_options'}
            <div class="delivery-options" style="height:0px; overflow:hidden">
          ...
          <div class="order-options">
            <div id="delivery">
              <div class="form-group">
                <h3>{l s="Votre numéro de commande interne" d='Shop.Theme.Checkout'}</h3>
                <label for="internal_reference">
                  {l s='Si vous avez un numéro de commande interne à nous communiquer, merci de le saisir ici' d='Shop.Theme.Checkout'}
                  <input type="text" id="internal_reference" class="form-control" name="internal_reference" value="{$internal_reference}">
                </label>
              </div>
              <div class="form-group">
                <h3>{l s="Instructions/Commentaires" d='Shop.Theme.Checkout'}</h3>
        ...
        <div class="row">
          <div class="col-lg-12 text-right">
            <div class="well">
              <button type="submit" class="btn btn-success bold continue" name="confirmDeliveryOption" value="1">
